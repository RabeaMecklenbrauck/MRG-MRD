...
```{r}
df<- read_xlsx("/Users/maximilianbader/Library/Mobile Documents/com~apple~CloudDocs/Universitaet/AG Heuser/analysis/2025/MRDMRGMshared/Export data for R/250811_MRGM-Data_Analysis_v43_anonym.xlsx", na = "na")
```
...
#Donor match
table(t2tx$Donor_match_Tx1, t2tx$t2_MRD_MRGM_positive1_negative0)
table_donor_match<-table(t2tx$Donor_match_Tx1, t2tx$t2_MRD_MRGM_positive1_negative0)
...
#aGvHD
table(t2tx$aGvHDmax_grade, t2tx$t2_MRD_MRGM_positive1_negative0)
table_agvhd_grade<-table(t2tx$aGvHDmax_grade, t2tx$t2_MRD_MRGM_positive1_negative0)
