...
```{r}
df<- read_xlsx("/Users/maximilianbader/Library/Mobile Documents/com~apple~CloudDocs/Universitaet/AG Heuser/analysis/2025/MRDMRGMshared/Export data for R/250915_MRGM-Data_Analysis_v47_anonym.xlsx", na = "na")
```
...
MRD characteristics t1andt2 (Median VAF, range) UNFERTIG
```{r}
#ASXL1
...
summary(t1andt2$t1_MRD_VAF_ASXL1) #ÜBERARBEITEN!
chisq.test(table_asxl1)
fisher.test(table_asxl1) #Fisher-Test weil Werte <5? 
#BCOR
...
summary(t1andt2$t1_MRD_VAF_BCOR) #FALSCH! ÜBERARBEITEN!
chisq.test(table_bcor)
fisher.test(table_bcor) #Fisher-Test weil Werte <5? 
#EZH2
...
summary(t1andt2$t1_MRD_VAF_EZH2) #ÜBERARBEITEN
chisq.test(table_ezh2)
fisher.test(table_ezh2) #Fisher-Test weil Werte <5? 
#RUNX1
...
summary(t1andt2$t1_MRD_VAF_RUNX1) #ÜBERARBEITEN!
chisq.test(table_runx1)
fisher.test(table_runx1) #Fisher-Test weil Werte <5? 
#SF3B1
...
summary(t1andt2$t1_MRD_VAF_SRSF2) #FALSCH! ÜBERARBEITEN!!
chisq.test(table_srsf2)
fisher.test(table_srsf2) #Fisher-Test weil Werte <5? 
#STAG2
...
summary(t1andt2$t1_MRD_VAF_STAG2) #ÜBERARBEITEN! FALSCH?
chisq.test(table_stag2)
#fisher.test(table_stag2) #Fisher-Test weil Werte <5? 
#U2AF1
...
summary(t1andt2$t1_MRD_VAF_ZRSR2) #ÜBERARBEITEN! FALSCH!
#chisq.test(table_zrsr2)
#fisher.test(table_zrsr2) #Fisher-Test weil Werte <5? 
...
t1bcorpos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_BCOR ==1) #FALSCH!! ÜBERARBEITEN!!!
...
t1STAG2pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_STAG2 ==1) #FALSCH! ÜBERARBEITEN!!!
...
t1ZRSR2pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_ZRSR2 ==1) #FALSCH!! *ÜBERARBEITEN!!!
#VAF Median & Range
summary(t1asxl1pos$t1_MRD_VAF_ASXL1)
summary(t1bcorpos$t1_MRD_VAF_BCOR) #FALSCH!
...
summary(t1STAG2pos$t1_MRD_VAF_STAG2) #FALSCH
summary(t1U2AF1pos$t1_MRD_VAF_U2AF1)
summary(t1ZRSR2pos$t1_MRD_VAF_ZRSR2) #FALSCH
```
