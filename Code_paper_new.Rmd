...
```{r}
df<- read_xlsx("/Users/maximilianbader/Library/Mobile Documents/com~apple~CloudDocs/Universitaet/AG Heuser/analysis/2025/MRDMRGMshared/Export data for R/250930_MRGM-Data_Analysis_v48_anonym.xlsx", na = "na")
```
...
Transplantation-associated characteristics of all patients included in t1 and t2 (t1andt2)
```{r}
nrow(t1andt2)
#HCT-CI score before Tx
t1andt2$HCTCI_over_under_2 <- ifelse(t1andt2$HCTCI_at_ED <= 2, 0, 1)
table(t1andt2$HCTCI_over_under_2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_hctci<-table(t1andt2$HCTCI_over_under_2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$HCTCI_over_under_2)])
chisq.test(table_hctci)
fisher.test(table_hctci) #Fisher-Test weil Werte <5? 
#number of chemotherapy cycles before Tx
table(t1andt2$cycles_before_Tx_1_2_3ormore, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_cyclesbeforeTx<-table(t1andt2$cycles_before_Tx_1_2_3ormore, t1andt2$t1_MRD_MRGM_positive1_negative0)
chisq.test(table_cyclesbeforeTx)
#Donor match
t1andt2$donor_match_grouped <- ifelse(t1andt2$Donor_match_Tx1 == 4, 3, t1andt2$Donor_match_Tx1)
table(t1andt2$donor_match_grouped, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_donor_match<-table(t1andt2$donor_match_grouped, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$donor_match_grouped)])
chisq.test(table_donor_match)
#Conditioning therapy MAC/RIC
table(t1andt2$MAC_vs_RIC, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_conditioning<-table(t1andt2$MAC_vs_RIC, t1andt2$t1_MRD_MRGM_positive1_negative0)
chisq.test(table_conditioning)
fisher.test(table_conditioning) #Fisher-Test weil Werte <5? 
#Stem cell source
table(t1andt2$StemCell_Source, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_stemcellsource<-table(t1andt2$StemCell_Source, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$StemCell_Source)])
chisq.test(table_stemcellsource)
fisher.test(table_stemcellsource) #Fisher-Test weil Werte <5? 
#Donor_sex
table(t1andt2$Donor_Sex_atTx1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_donorsex<-table(t1andt2$Donor_Sex_atTx1, t1andt2$t1_MRD_MRGM_positive1_negative0)
chisq.test(table_donorsex)
#CMV status
table(t1andt2$CMVstatus_PnegDneg_vs_rest, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_cmvstatus<-table(t1andt2$CMVstatus_PnegDneg_vs_rest, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$CMVstatus_PnegDneg_vs_rest)])
chisq.test(table_cmvstatus)
#CMV reactivation
# missing!

#aGvHD
t1andt2$aGvHD_grouped <- ifelse(t1andt2$aGvHDmax_grade == 0, 0, ifelse(t1andt2$aGvHDmax_grade %in% c(1, 2), 1, 2))
table(t1andt2$aGvHD_grouped, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_agvhd_grade<-table(t1andt2$aGvHD_grouped, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$aGvHD_grouped)])
chisq.test(table_agvhd_grade)
#cGvHD
table(t2tx$cGvHD_Tx1_grade, t2tx$t1_MRD_MRGM_positive1_negative0)
table_cgvhd<-table(t2tx$cGvHD_Tx1_grade, t2tx$t1_MRD_MRGM_positive1_negative0)
table(t2tx$t1_MRD_MRGM_positive1_negative0[is.na(t2tx$cGvHD_Tx1_grade)])
chisq.test(table_cgvhd)
```
...
MRD characteristics t1andt2 (Median VAF, range)
```{r}
#ASXL1
table (t1andt2$t1_MRD_ASXL1)
table(t1andt2$t1_MRD_ASXL1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_asxl1<-table(t1andt2$t1_MRD_ASXL1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_ASXL1)])
summary(t1andt2$t1_MRD_VAF_ASXL1)
chisq.test(table_asxl1)
fisher.test(table_asxl1) #Fisher-Test weil Werte <5? 
#BCOR
table (t1andt2$t1_MRD_BCOR)
table(t1andt2$t1_MRD_BCOR, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_bcor<-table(t1andt2$t1_MRD_BCOR, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_BCOR)])
summary(t1andt2$t1_MRD_VAF_BCOR_X_adjusted)
chisq.test(table_bcor)
fisher.test(table_bcor) #Fisher-Test weil Werte <5? 
#EZH2
table(t1andt2$t1_MRD_EZH2)
table(t1andt2$t1_MRD_EZH2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_ezh2<-table(t1andt2$t2_MRD_EZH2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_EZH2)])
summary(t1andt2$t1_MRD_VAF_EZH2)
chisq.test(table_ezh2)
#RUNX1
table(t1andt2$t1_MRD_RUNX1)
table(t1andt2$t1_MRD_RUNX1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_runx1<-table(t1andt2$t1_MRD_RUNX1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_RUNX1)])
summary(t1andt2$t1_MRD_VAF_RUNX1)
chisq.test(table_runx1)
fisher.test(table_runx1) #Fisher-Test weil Werte <5? 
#SF3B1
table(t1andt2$t1_MRD_SF3B1)
table(t1andt2$t1_MRD_SF3B1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_sf3b1<-table(t1andt2$t1_MRD_SF3B1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_SF3B1)])
summary(t1andt2$t1_MRD_VAF_SF3B1)
chisq.test(table_sf3b1)
#fisher.test(table_sf3b1) #Fisher-Test weil Werte <5? 
#SRSF2
table(t1andt2$t1_MRD_SRSF2)
table(t1andt2$t1_MRD_SRSF2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_srsf2<-table(t1andt2$t2_MRD_SRSF2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_SRSF2)])
summary(t1andt2$t1_MRD_VAF_SRSF2)
chisq.test(table_srsf2)
fisher.test(table_srsf2) #Fisher-Test weil Werte <5? 
#STAG2
table(t1andt2$t1_MRD_STAG2)
table(t1andt2$t1_MRD_STAG2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_stag2<-table(t1andt2$t1_MRD_STAG2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_STAG2)])
summary(t1andt2$t1_MRD_VAF_STAG2_X_adjusted)
chisq.test(table_stag2)
#fisher.test(table_stag2) #Fisher-Test weil Werte <5? 
#U2AF1
table(t1andt2$t1_MRD_U2AF1)
table(t1andt2$t1_MRD_U2AF1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_u2af1<-table(t1andt2$t1_MRD_U2AF1, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_U2AF1)])
summary(t1andt2$t1_MRD_VAF_U2AF1)
chisq.test(table_u2af1)
fisher.test(table_u2af1) #Fisher-Test weil Werte <5? 
#ZRSR2
table(t1andt2$t1_MRD_ZRSR2)
table(t1andt2$t1_MRD_ZRSR2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table_zrsr2<-table(t1andt2$t1_MRD_ZRSR2, t1andt2$t1_MRD_MRGM_positive1_negative0)
table(t1andt2$t1_MRD_MRGM_positive1_negative0[is.na(t1andt2$t1_MRD_ZRSR2)])
summary(t1andt2$t1_MRD_VAF_ZRSR2)
#chisq.test(table_zrsr2)
#fisher.test(table_zrsr2) #Fisher-Test weil Werte <5? 

#VAF Median and Range, only of MRD positives: #ÜBERARBEITEN!!!!!!
#subsets 
t1asxl1pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_ASXL1 ==1)
t1bcorpos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_BCOR ==1)
t1EZH2pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_EZH2 ==1)
t1RUNX1pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_RUNX1 ==1)
t1SF3B1pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_SF3B1 ==1)
t1SRSF2pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_SRSF2 ==1)
t1STAG2pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_STAG2 ==1)
t1U2AF1pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_U2AF1 ==1)
t1ZRSR2pos=subset(df, df$`Einschluss t1_oder_t2`==1 & df$t2_eingeschlossen1_ausgeschlossen0==1 & df$Tx_yes_no==1 & df$Txin_CR1_vs_CR2 == 1 & df$t1_MRD_ZRSR2 ==1)
#VAF Median & Range
summary(t1asxl1pos$t1_MRD_VAF_ASXL1)
summary(t1bcorpos$t1_MRD_VAF_BCOR_X_adjusted)
summary(t1EZH2pos$t1_MRD_VAF_EZH2)
summary(t1RUNX1pos$t1_MRD_VAF_RUNX1)
summary(t1SF3B1pos$t1_MRD_VAF_SF3B1)
summary(t1SRSF2pos$t1_MRD_VAF_SRSF2)
summary(t1STAG2pos$t1_MRD_VAF_STAG2_X_adjusted)
summary(t1U2AF1pos$t1_MRD_VAF_U2AF1)
summary(t1ZRSR2pos$t1_MRD_VAF_ZRSR2)
```
...
df <- df %>%
  dplyr::mutate(
    trend_up_gene1 = case_when(
      is.na(VAF_gene1_t2) | is.na(VAF_gene1_t1) ~ NA_integer_,
      VAF_gene1_t2 > VAF_gene1_t1 ~ 1L,
      TRUE ~ 0L
    ),
    trend_up_gene2 = case_when(
      is.na(VAF_gene2_t2) | is.na(VAF_gene2_t1) ~ NA_integer_,
      VAF_gene2_t2 > VAF_gene2_t1 ~ 1L,
      TRUE ~ 0L
    ),
    trend_up_gene3 = case_when(
      is.na(VAF_gene3_t2) | is.na(VAF_gene3_t1) ~ NA_integer_,
      VAF_gene3_t2 > VAF_gene3_t1 ~ 1L,
      TRUE ~ 0L
    ),
    trend_up_gene4 = case_when(
      is.na(VAF_gene4_t2) | is.na(VAF_gene4_t1) ~ NA_integer_,
      VAF_gene4_t2 > VAF_gene4_t1 ~ 1L,
      TRUE ~ 0L
    )
  ) %>%
  dplyr::mutate(
    n_na   = rowSums(is.na(dplyr::across(starts_with("trend_up_gene")))),
    n_ones = rowSums(dplyr::across(starts_with("trend_up_gene")) == 1, na.rm = TRUE),
    n_vals = rowSums(!is.na(dplyr::across(starts_with("trend_up_gene")))),

    any_trend_up_pt = case_when(
      n_vals == 0                ~ NA_integer_,
      n_ones > 0                 ~ 1L,
      TRUE                       ~ 0L
    )
  ) %>%
  dplyr::select(-n_na, -n_ones, -n_vals)

```
Subsets have to be defined again!

Survival analysis of patients with increased VAF vs. decreased / consistent VAF
OS VAF increased / decreased  (t1andt2)
```{r}
fit_t1cohort<- survfit(Surv(OS_years_censored, OS_status)~t1andt2$any_trend_up_pt, data=t1andt2)
ggsurv <- ggsurvplot(
  fit_t1cohort,                     # survfit object with calculated statistics.
  data = t1andt2,             # data used to fit survival curves.
  risk.table = TRUE, fontsize = 5,      # show risk table.
  ...
  # in legend of risk table.
  ncensor.plot = FALSE,      # plot the number of censored subjects at time t
  legend.labs = c("consistent/decreased VAF", "increased VAF"),    # change legend labels.
  legend.title = element_blank() # Remove the legend title
)
ggsurv$plot <- ggsurv$plot + 
  theme(
...
Calculate the p value with logrank test and Cox regression.
```{r}
survdiff(Surv(OS_years_censored, OS_status)~t1andt2$any_trend_up_pt, data=t1andt2)
coxph(Surv(OS_years_censored, OS_status) ~ t1andt2$any_trend_up_pt, data=t1andt2) %>% 
  tbl_regression(exp = TRUE)
```
RFS STAG2 t1cohort (t1andt2)
```{r}
fit_t1cohort<- survfit(Surv(RFS_years_censored, RFS_status)~t1andt2$any_trend_up_pt, data=t1andt2)
ggsurv <- ggsurvplot(
  fit_t1cohort,                     # survfit object with calculated statistics.
  data = t1andt2,             # data used to fit survival curves.
  risk.table = TRUE, fontsize = 5,      # show risk table.
...
Calculate the p value with logrank test and Cox regression.
```{r}
survdiff(Surv(RFS_years_censored, RFS_status)~t1andt2$any_trend_up_pt, data=t1andt2)
coxph(Surv(RFS_years_censored, RFS_status) ~ t1andt2$any_trend_up_pt, data=t1andt2) %>% 
  tbl_regression(exp = TRUE)
```
CIR STAG2 t1cohort (t1andt2)
```{r}
ci.all<-cuminc(ftime=t1andt2$RFS_years_censored,fstatus=t1andt2$CIR_event,group=t1andt2$any_trend_up_pt)
print(ci.all)
# select subset only CIR, no NRM [3:4]
fig<- ggcompetingrisks( fit =ci.all,
gnames = NULL,
...
xlab = "Years", 
ylab = "Probability")
fig<-fig+scale_color_manual(name="", values=c("#786E64","#F03C14"), labels=c("consistent/decreased VAF", "increased VAF"))
fig<-fig+scale_x_continuous(breaks=c(0, 2, 4, 6, 8, 10))
fig<-fig+geom_step(linewidth = 1.5)
fig<-fig+theme_classic2()+theme(legend.position = "top")
fig$mapping <- aes(x = time, y = est, colour = group, linetype = event)
print(fig)
#p-value CIR
fine_gray_test <- crr(t1andt2$RFS_years_censored, t1andt2$CIR_event == 1, t1andt2$any_trend_up_pt)
summary(fine_gray_test)
#p-value NRM
fine_gray_test <- crr(t1andt2$RFS_years_censored, t1andt2$CIR_event == 2, t1andt2$any_trend_up_pt)
summary(fine_gray_test)
```
...
Median Follow Up t2
```{r}
median_FU_years <- median(
  as.numeric(as.Date(as.numeric(t2tx$FU_Dat), origin = "1899-12-30") -
             as.Date(as.numeric(t2tx$Date_ED), origin = "1899-12-30")) / 365.25,
  na.rm = TRUE
)
...
```{r}
median_FU_years <- median(
  as.numeric(as.Date(as.numeric(t1andt2$FU_Dat), origin = "1899-12-30") -
             as.Date(as.numeric(t1andt2$Date_ED), origin = "1899-12-30")) / 365.25,
  na.rm = TRUE
)
...
Number of mutations t2
```{r}
cols <- c("MRD_gene1_t2 neg0pos1", "MRD_gene2_t2 neg0pos1", "MRD_gene3_t2 neg0pos1", "MRD_gene4_t2 neg0pos1")
n_entries <- sum(!is.na(unlist(t2tx[cols])))
n_entries

#per patient:
cols <- c("MRD_gene1_t2 neg0pos1", "MRD_gene2_t2 neg0pos1",
          "MRD_gene3_t2 neg0pos1", "MRD_gene4_t2 neg0pos1")

t2tx$mutation_count <- rowSums(!is.na(t2tx[cols]))

# Median und Range berechnen
median_mut <- median(t2tx$mutation_count, na.rm = TRUE)
range_mut  <- range(t2tx$mutation_count, na.rm = TRUE)

list(median = median_mut, range = range_mut)
```
Number of comutations t2
```{r}
cols <- c("MRD_Co-gene1_t2 neg0pos1", "MRD_Co-gene2_t2 neg0pos1",
          "MRD_Co-gene3_t2 neg0pos1", "MRD_Co-gene4_t2 neg0pos1",
          "MRD_Co-gene5_t2 neg0pos1", "MRD_Co-gene6_t2 neg0pos1",
          "MRD_Co-gene7_t2 neg0pos1")

# Gesamtzahl CoM
total_entries <- sum(!is.na(unlist(t2tx[cols])))

# Anzahl Pat. mit CoM
patients_with_entry <- sum(rowSums(!is.na(t2tx[cols])) > 0)

# Anzahl CoM pro Pat. Median/Range
per_patient_counts <- rowSums(!is.na(t2tx[cols]))

median_entries <- median(per_patient_counts[per_patient_counts > 0])
range_entries  <- range(per_patient_counts[per_patient_counts > 0])

list(
  total_entries = total_entries,
  patients_with_entry = patients_with_entry,
...
Number of mutations t1andt2
```{r}
cols <- c("MRD_gene1_t1 neg0pos1", "MRD_gene2_t1 neg0pos1", "MRD_gene3_t1 neg0pos1", "MRD_gene4_t1 neg0pos1")
n_entries <- sum(!is.na(unlist(t1andt2[cols])))
n_entries

#per patient:
cols <- c("MRD_gene1_t1 neg0pos1", "MRD_gene2_t1 neg0pos1",
          "MRD_gene3_t1 neg0pos1", "MRD_gene4_t1 neg0pos1")

t1andt2$mutation_count <- rowSums(!is.na(t1andt2[cols]))

# Median und Range berechnen
median_mut <- median(t1andt2$mutation_count, na.rm = TRUE)
range_mut  <- range(t1andt2$mutation_count, na.rm = TRUE)

list(median = median_mut, range = range_mut)
```
Number of comutations t1andt2
```{r}
cols <- c("MRD_Co-gene1_t1 neg0pos1", "MRD_Co-gene2_t1 neg0pos1",
          "MRD_Co-gene3_t1 neg0pos1", "MRD_Co-gene4_t1 neg0pos1",
          "MRD_Co-gene5_t1 neg0pos1", "MRD_Co-gene6_t1 neg0pos1",
          "MRD_Co-gene7_t1 neg0pos1")

# Gesamtzahl CoM
total_entries <- sum(!is.na(unlist(t1andt2[cols])))

# Anzahl Pat. mit CoM
patients_with_entry <- sum(rowSums(!is.na(t1andt2[cols])) > 0)

# Anzahl CoM pro Pat. Median/Range
per_patient_counts <- rowSums(!is.na(t1andt2[cols]))
...
Median time between Tx and sample t2
```{r}

t2tx$alloTx_Dat <- as.Date(t2tx$alloTx_Dat, origin = "1899-12-30")
t2tx$Sample_Date_MRD_t2 <- as.POSIXct(t2tx$Sample_Date_MRD_t2, origin = "1970-01-01", tz = "UTC")
t2tx$Sample_Date_MRD_t2 <- as.Date(t2tx$Sample_Date_MRD_t2)
daystxtosample_diff <- as.numeric(t2tx$Sample_Date_MRD_t2 - t2tx$alloTx_Dat)
median(daystxtosample_diff, na.rm = TRUE)
daystxtosample_diff <- as.numeric(t2tx$Sample_Date_MRD_t2 - t2tx$alloTx_Dat)
range(daystxtosample_diff, na.rm = TRUE)
```


Mediane VAF MRD positives t2
```{r}
vaf_cols <- c("t2_MRD_VAF_ASXL1",
              "t2_MRD_VAF_BCOR_X_adjusted",
              "t2_MRD_VAF_EZH2",
              "t2_MRD_VAF_RUNX1",
              "t2_MRD_VAF_SF3B1",
              "t2_MRD_VAF_SRSF2",
              "t2_MRD_VAF_STAG2_X_adjusted",
              "t2_MRD_VAF_U2AF1",
              "t2_MRD_VAF_ZRSR2")

mrd_cols <- c("t2_MRD_ASXL1",
              "t2_MRD_BCOR",
              "t2_MRD_EZH2",
              "t2_MRD_RUNX1",
              "t2_MRD_SF3B1",
...
# Only positives
vaf_all <- c()
for (i in seq_along(vaf_cols)) {
  vals <- t2tx[[vaf_cols[i]]][t2tx[[mrd_cols[i]]] == 1]
  vaf_all <- c(vaf_all, vals)
}

# Median & Range
median_vaf <- median(vaf_all, na.rm = TRUE)
range_vaf <- range(vaf_all, na.rm = TRUE)

median_vaf
range_vaf
summary(vaf_all)
```
Mediane VAF MRD positives t2 without ASXL1
```{r}
vaf_cols <- c("t2_MRD_VAF_BCOR_X_adjusted",
              "t2_MRD_VAF_EZH2",
              "t2_MRD_VAF_RUNX1",
              "t2_MRD_VAF_SF3B1",
              "t2_MRD_VAF_SRSF2",
...
summary(vaf_all)
```
Mediane VAF MRD all (MRD negatives and positives) t2 = 0!
```{r}
vaf_cols_all <- c("VAF_X_adjusted_gene1_t2",
                  "VAF_X_adjusted_gene2_t2",
                  "VAF_X_adjusted_gene3_t2",
                  "VAF_X_adjusted_gene4_t2")

vaf_all_mut <- c()
for (col in vaf_cols_all) {
  vaf_all_mut <- c(vaf_all_mut, t2tx[[col]])
}

# Median & Range
median_vaf_all <- median(vaf_all_mut, na.rm = TRUE)
range_vaf_all <- range(vaf_all_mut, na.rm = TRUE)
...
Mediane VAF MRD positives t1andt2
```{r}
vaf_cols <- c("t1_MRD_VAF_ASXL1",
              "t1_MRD_VAF_BCOR_X_adjusted",
              "t1_MRD_VAF_EZH2",
              "t1_MRD_VAF_RUNX1",
              "t1_MRD_VAF_SF3B1",
              "t1_MRD_VAF_SRSF2",
              "t1_MRD_VAF_STAG2_X_adjusted",
              "t1_MRD_VAF_U2AF1",
              "t1_MRD_VAF_ZRSR2")

mrd_cols <- c("t1_MRD_ASXL1",
              "t1_MRD_BCOR",
              "t1_MRD_EZH2",
              "t1_MRD_RUNX1",
              "t1_MRD_SF3B1",
...
vaf_all <- c()
for (i in seq_along(vaf_cols)) {
  vals <- t1andt2[[vaf_cols[i]]][t1andt2[[mrd_cols[i]]] == 1]
  vaf_all <- c(vaf_all, vals)
}
...
summary(vaf_all)
```
Mediane VAF MRD positives t1andt2 without ASXL1
```{r}
vaf_cols <- c("t1_MRD_VAF_BCOR_X_adjusted",
              "t1_MRD_VAF_EZH2",
              "t1_MRD_VAF_RUNX1",
              "t1_MRD_VAF_SF3B1",
              "t1_MRD_VAF_SRSF2",
...
summary(vaf_all)
```
Mediane VAF MRD all (MRD negatives and positives) t1andt2
```{r}
vaf_cols_all <- c("VAF_X_adjusted_gene1_t1",
                  "VAF_X_adjusted_gene2_t1",
                  "VAF_X_adjusted_gene3_t1",
                  "VAF_X_adjusted_gene4_t1")

vaf_all_mut <- c()
for (col in vaf_cols_all) {
  vaf_all_mut <- c(vaf_all_mut, t1andt2[[col]])
}
